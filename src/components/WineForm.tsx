  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        >
          <LabelPhoto uri={photoFullUri} onPress={onPickPhoto} height={220} />
          ...
          <View style={styles.section}>
            <Text style={[styles.sectionTitle, { color: colors.textMuted }]}>Note</Text>
          ...
          <View style={styles.section}>
            <Text style={[styles.sectionTitle, { color: colors.textMuted }]}>Où ?</Text>
            <LocationPicker
          ...
          <View style={styles.section}>
            <BuyAgainToggle value={form.buy_again} onChange={(v) => update('buy_again', v)} />
          </View>
...
const styles = StyleSheet.create({
  ...
  restaurantInput: { marginTop: spacing.md },
  starsPreview: { marginTop: -spacing.xs },
  commentInput: {
    minHeight: 96,
